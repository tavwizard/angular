...
function _replaceIndices(r:ProtoRecord, selfIndex:number, indexMap:Map<number, number>): ProtoRecord {
...
function _map(indexMap:Map<number, number>, value:number): number {
