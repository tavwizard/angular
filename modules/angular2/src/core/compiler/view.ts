...
import {AST, Locals, ChangeDispatcher, ProtoChangeDetector, ChangeDetector,
  BindingRecord, DirectiveRecord, ChangeDetectorRef} from 'angular2/change_detection';
...
export class AppView {
  ...
  constructor(renderer:renderApi.Renderer, proto:AppProtoView, protoLocals:Map<any,any>) {
    this.render = null;
    this.proto = proto;
  ...
  init(changeDetector:ChangeDetector, elementInjectors:List<any>, rootElementInjectors:List<any>,
  ...
  setLocal(contextName: string, value) {
    ...
    var templateName = <string>MapWrapper.get(this.proto.variableBindings, contextName);
...
export class AppProtoView {
  ...
  _directiveRecordsMap:Map<any,any>;
  _directiveRecords:List<any>;
