...
export class Injector {
   ...
   */
  static resolve(bindings:List<any>/*<ResolvedBinding|Binding|Type|List>*/):List<ResolvedBinding> {
   ...
   */
  static resolveAndCreate(bindings:List<any>/*<ResolvedBinding|Binding|Type|List>*/, {defaultBindings=false}={defaultBindings:false}) {
   ...
   * @param [defaultBindings] Setting to true will auto-create bindings.
   */
  static fromResolvedBindings(bindings:List<ResolvedBinding>, {defaultBindings=false}={defaultBindings:false}) {
   ...
   */
  resolveAndCreateChild(bindings:List<any>/*<ResolvedBinding|Binding|Type|List>*/):Injector {
...
function _resolveBindings(bindings:List<any>): List<any> {
  ...
  for (var i = 0; i < bindings.length; i++) {
    ...
    } else if (unresolved instanceof TypeClass) {
